...
import { createPost, getCategory, getTag } from '../../Services/postServices';
...
function CreatePost() {
    ...
    const handleSubmit = (e) => {
        ...
        createPost(title.value, body.value, category.value, tagid)
        .then((data) => {
        ...
        <div>
            <Form className='border border-1 border-dark mt-2 p-2' onSubmit={handleSubmit}>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" id="title" placeholder="Blog Title" required />
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Label className='fw-bold'>Body</Form.Label>
                    <Form.Control as="textarea" id="body" rows={3} required />
                </Form.Group>
                <Form.Group className="mb-3">
